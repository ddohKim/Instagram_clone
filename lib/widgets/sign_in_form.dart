        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              FlatButton(
                  onPressed: () {},
                  child: Align( //flatbutton은 배열하는 곳이 없어서 글자자체를 오른쪽 배열시켜줌
              ...
              ordivider(),
              FlatButton.icon(
                  //facebook 이동 아이콘을 만드는데 아이콘과 text 동시에 사용되는 것
                  onPressed: () {
                    Provider.of<FirebaseAuthState>(context,listen: false).loginWithFacebook(context); //notifyListener 를 통해서
                  },
